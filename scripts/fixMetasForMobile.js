...
const data = fs.readFileSync(path.join(__dirname, '../www/index.html'), 'utf8');

const insertContent = (fullContent, beforeWhat, newContent) => {
...
const replacedBundle = afterAddingScript.replace('src="/bundle.js', 'src="bundle.js');
// updates the index.html file
fs.writeFile(path.join(__dirname, '../www/index.html'), replacedBundle, 'utf8', (err)=> {
  if(err) {
      throw err
  };
})